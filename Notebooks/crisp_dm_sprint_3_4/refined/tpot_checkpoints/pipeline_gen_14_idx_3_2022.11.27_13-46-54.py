...
# Average CV score on the training set was: 0.7871794871794872
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=ExtraTreesClassifier(bootstrap=True, criterion="entropy", max_features=0.6500000000000001, min_samples_leaf=5, min_samples_split=10, n_estimators=100)),
